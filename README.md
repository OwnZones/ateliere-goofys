...
[![Build Status](https://travis-ci.org/OwnZones/ateliere-goofys.svg?branch=master)](https://travis-ci.org/OwnZones/ateliere-goofys)
[![Github All Releases](https://img.shields.io/github/downloads/OwnZones/ateliere-goofys/total.svg)](https://github.com/OwnZones/ateliere-goofys/releases/)
...
See also: [Instruction for Azure Blob Storage, Azure Data Lake Gen1, and Azure Data Lake Gen2](https://github.com/OwnZones/ateliere-goofys/blob/master/README-azure.md).

Got more questions? Check out [questions other people asked](https://github.com/OwnZones/ateliere-goofys/issues?utf8=%E2%9C%93&q=is%3Aissue%20label%3Aquestion%20)
...
[bench.sh](https://github.com/OwnZones/ateliere-goofys/blob/master/bench/bench.sh). [Raw data](https://github.com/OwnZones/ateliere-goofys/blob/master/bench/)
...
See also: [cached benchmark result](https://github.com/OwnZones/ateliere-goofys/blob/master/bench/cache/README.md) and [result on Azure](https://github.com/OwnZones/ateliere-goofys/blob/master/bench/azure/README.md).
